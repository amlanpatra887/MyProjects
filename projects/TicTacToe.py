...
# Backend - Game Logic
class TicTacToeGame:
    def __init__(self, players=(Player("X", "blue"), Player("O", "green")), board_size=BOARD_SIZE):
...
class TicTacToeBoard(tk.Tk):
    ...
    def play(self, event):
        ...
        if self._game.is_valid_move(move):
            ...
            win = self._game.process_move(move)
            if win:
                self._highlight_cells()
                messagebox.showinfo("Game Over!", f"Player '{self._game.current_player.label}' wins!")
    ...
    def reset_board(self):
        ...
        self._update_display(msg="Player X's turn")
